...
### Datasets
| CTR Dataset | Description | #Fields | #Fields | #Instances | #Train | #Validate | #Test | 
| :-----: |:------------|:-----------:|:-----------:| :-------:|:-------:|:----------:|:------:|
| **Recommendation** |
...
| Frappe  | [A dataset for context-aware app recommendation in Frappe](https://arxiv.org/abs/1505.03014) | | | | |||
| **Ad targeting** |
